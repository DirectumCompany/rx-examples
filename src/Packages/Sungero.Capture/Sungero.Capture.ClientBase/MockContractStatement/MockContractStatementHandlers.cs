...
namespace Sungero.Capture
{
  partial class MockContractStatementClientHandlers
  {
    ...
    {
      this._obj.State.Properties.BusinessUnitTrrc.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void BusinessUnitTinValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.BusinessUnitTin.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void BusinessUnitNameValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.BusinessUnitName.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void CounterpartyTrrcValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.CounterpartyTrrc.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void CounterpartyTinValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.CounterpartyTin.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void CounterpartyNameValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.CounterpartyName.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void LeadDocValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.LeadDoc.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }
  }
