...
namespace Sungero.Capture
{
  partial class MockIncomingLetterClientHandlers
  {
    ...
    {
      this._obj.State.Properties.RecipientTrrc.HighlightColor = Sungero.Core.Colors.Empty;
    }

    public virtual void RecipientTinValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.RecipientTin.HighlightColor = Sungero.Core.Colors.Empty;
    }

    public virtual void RecipientValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.Recipient.HighlightColor = Sungero.Core.Colors.Empty;
    }
    ...
    {
      this._obj.State.Properties.Signatory.HighlightColor = Sungero.Core.Colors.Empty;
    }
    ...
    {
      this._obj.State.Properties.CorrespondentTrrc.HighlightColor = Sungero.Core.Colors.Empty;
    }

    public virtual void CorrespondentTinValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.CorrespondentTin.HighlightColor = Sungero.Core.Colors.Empty;
    }
