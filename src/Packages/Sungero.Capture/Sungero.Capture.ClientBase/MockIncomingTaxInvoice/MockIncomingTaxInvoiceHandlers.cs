...
namespace Sungero.Capture
{
  partial class MockIncomingTaxInvoiceClientHandlers
  {
    ...
    {
      this._obj.State.Properties.BuyerTrrc.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void BuyerTinValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.BuyerTin.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void BuyerNameValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.BuyerName.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }
    ...
    {
      this._obj.State.Properties.ConsigneeName.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }
    ...
    {
      this._obj.State.Properties.ShipperName.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void SellerTrrcValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.SellerTrrc.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void SellerTinValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.SellerTin.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void SellerNameValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.SellerName.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }

    public virtual void RevisionValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      this._obj.State.Properties.Revision.HighlightColor = Sungero.Core.Colors.Highlights.Empty;
    }
