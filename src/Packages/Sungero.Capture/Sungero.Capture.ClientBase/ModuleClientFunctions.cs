...
namespace Sungero.Capture.Client
{
  public class ModuleFunctions
  {
    ...
    public virtual Structures.Module.ICapturedMailFiles GetCapturedMailFiles(string filesInfo, string folder)
    {
      ...
      mailFiles.Attachments = new List<Sungero.Docflow.Structures.Module.IFileDto>();
    ...
    public virtual Sungero.Docflow.Structures.Module.IFileDto CreateFileInfoFromXelement(System.Xml.Linq.XElement xmlElement, string folder)
    {
      var file = Sungero.Docflow.Structures.Module.FileDto.Create();
    ...
    public virtual void ProcessScanPackage(string filesInfo, string folder, Sungero.Company.IEmployee responsible, string senderLineName = "")
    {
      ...
      foreach (var packagePath in packagesPaths)
      {
        ...
        var originalFile = new Sungero.Docflow.Structures.Module.FileDto();
