...
namespace Sungero.Examples.Constants.Docflow
{
  public static class Memo
  {
    ...
    [Public]
    public const string SignMarkKindClass = "Sungero.Examples.Functions.Memo";

    // Имя метода получения отметки "Утверждено".
    [Public]
    public const string SignMarkKindMethod = "GetMemoSignMarkAsHtml";
    
    // Имя дополнительного параметра отметки "Утверждено".
    [Public]
    public const string MarkSignatureIdKey = "SignatureId";
  }
}